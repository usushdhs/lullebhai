...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8155546110:AAHxBeAc30A4nx5hSgSEFfrCXTj_2cNBTio'
OWNER_IDS = [6434780221, 7098912960]  # List of allowed owner IDs
CO_OWNERS = []  # List of user IDs for co-owners
OWNER_CONTACT = "Contact to buy keys"
ALLOWED_GROUP_IDS = [-1002798585588]
MAX_THREADS = 1000
max_duration = 120
bot_open = False
OWNER_USERNAME = "@LULEEBHAI"
...
START_IMAGES = [
    {
        ...
        'caption': (
            ...
            '⚠️ *🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🤬*⚠️' + '\n\n'
            '⚠️ *JOIN CHANNEL  https://t.me/+xqFOrlPY3HZkMzA1 *' + '\n\n'
        )
    },
